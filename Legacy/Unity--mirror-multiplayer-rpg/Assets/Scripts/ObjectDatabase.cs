...
namespace MULTIPLAYER_GAME.Systems
{
    public class ObjectDatabase : NetworkBehaviour
    {
        ...
        private void Awake()
        {
            ...
            foreach (var spawn in FindObjectsByType<EntitySpawnPosition>(FindObjectsSortMode.None))
            {
        ...
        private void ServerPositionMessageHandler(NetworkConnectionToClient conn, PositionMessage msg)
        {
        ...
        private void ClientPositionMessageHandler(PositionMessage msg)
        {
            Entity entity = GetEntity(msg.ID);
