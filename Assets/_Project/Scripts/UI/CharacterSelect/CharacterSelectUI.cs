...
namespace EtherDomes.UI
{
    ...
    public class CharacterSelectUI : MonoBehaviour, ICharacterSelectUI
    {
        ...
        private void CreateCharacterSlot(CharacterData character)
        {
            ...
            if (nameText != null)
            {
                nameText.text = $"{character.CharacterName} - {character.Class} Lv.{character.Level}";
            }
        ...
        private void UpdateSelectedDisplay()
        {
            ...
            {
                if (_selectedNameText != null) _selectedNameText.text = _selectedCharacter.CharacterName;
                if (_selectedClassText != null) _selectedClassText.text = _selectedCharacter.Class.ToString();
