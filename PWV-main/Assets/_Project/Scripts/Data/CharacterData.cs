...
namespace EtherDomes.Data
{
    ...
    /// LEGACY: Use CharacterData from CharacterSaveData.cs instead.
    /// </summary>
    [Serializable]
    public class LegacyCharacterData
    {
        ...
        public LegacyCharacterData()
        {
            CharacterId = Guid.NewGuid().ToString();
            CharacterName = "New Character";
            Class = CharacterClass.Cruzado;
            CurrentSpec = Specialization.CruzadoTank;
            Level = 1;
            Experience = 0;
        ...
        public CharacterStats GetTotalStats()
        {
            ...
            if (Equipment != null)
            {
                total.Add(Equipment.GetTotalStatsAsCharacterStats());
            }
            return total;
        }
