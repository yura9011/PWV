...
namespace EtherDomes.Tests.PropertyTests
{
    ...
    public abstract class PropertyTestBase
    {
        ...
        /// <summary>
        /// Run a simple property test without random inputs.
        /// Useful for deterministic invariant checks.
        /// </summary>
        protected void RunPropertyTest(System.Action test, int iterations = 1)
        {
