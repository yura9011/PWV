...
{
    /// <summary>
    /// Third-person camera controller with zoom and ground collision.
    ...
    public class ThirdPersonCameraController : MonoBehaviour
    {
        ...
        [SerializeField] private float _maxDistance = 16f; // Double default
        ...
        private void UpdateCameraPosition()
        {
            ...
            // Ground collision - prevent camera from going below ground
            desiredPosition = ApplyGroundCollision(targetPos, desiredPosition);
            
            // Obstacle collision - pull camera closer if something is in the way
            desiredPosition = ApplyObstacleCollision(targetPos, desiredPosition);
