...
namespace EtherDomes.UI.Debug
{
    ...
    public class NewClassesTestUI : MonoBehaviour
    {
        ...
        private Color GetResourceColor(SecondaryResourceType resourceType)
        {
            ...
            {
                SecondaryResourceType.Energia => new Color(1f, 0.96f, 0.41f),
                SecondaryResourceType.Colera => Color.red,
                SecondaryResourceType.Mana => new Color(0.3f, 0.5f, 1f),
                SecondaryResourceType.EnergiaRunica => new Color(0.3f, 0.8f, 0.9f),
                _ => Color.white
            };
        }
