...
namespace EtherDomes.Editor
{
    public static class FCTPrefabSetup
    {
        ...
        private static void AddFCTToScene()
        {
            ...
            var existing = Object.FindFirstObjectByType<EtherDomes.Combat.Visuals.FloatingCombatText>();
            if (existing != null)
            {
            ...
            var fct = fctObj.AddComponent<EtherDomes.Combat.Visuals.FloatingCombatText>();
        ...
        private static void AssignPrefabToFCT(EtherDomes.Combat.Visuals.FloatingCombatText fct)
        {
            string prefabPath = "Assets/_Project/Prefabs/UI/FCTText.prefab";
            ...
            var field = typeof(EtherDomes.Combat.Visuals.FloatingCombatText).GetField("_fctPrefab",
