...
namespace EtherDomes.Editor
{
    ...
    public static class NetworkTestSceneSetup
    {
        ...
        public static void CreateNetworkTestScene()
        {
            ...
            // NetworkManager with Mirror
            GameObject networkManager = new GameObject("NetworkManager");
            var sessionManager = networkManager.AddComponent<MirrorNetworkSessionManager>();
            networkManager.AddComponent<kcp2k.KcpTransport>();
            networkManager.AddComponent<MirrorConnectionApprovalAuthenticator>();
        ...
        private static void CreateConnectionUI()
        {
            ...
            // Add controller
            var controller = canvasObj.AddComponent<UI.MirrorMainMenuController>();
        }
