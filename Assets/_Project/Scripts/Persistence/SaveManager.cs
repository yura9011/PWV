...
namespace EtherDomes.Persistence
{
    public class SaveManager : MonoBehaviour
    {
        ...
        public void CreateCharacter(string name, int classId)
        {
            ...
            // newChar.Level = 1; // Default
            
            // Note: CharacterData constructor sets defaults. 
            // We need to set generic fields since CharacterData in this project is complex.
            // Assuming CharacterData has Name field based on previous view_file.
