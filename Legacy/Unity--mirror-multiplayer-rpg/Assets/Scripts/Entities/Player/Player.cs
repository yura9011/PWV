...
namespace MULTIPLAYER_GAME.Entities
{
    ...
    public class Player : Entity
    {
        ...
        // network
        public readonly SyncDictionaryInventoryData inventoryData = new SyncDictionaryInventoryData();
        public readonly SyncDictionaryEquipmentData equipmentData = new SyncDictionaryEquipmentData();
        ...
        public override void Start()
        {
            ...
            inventoryData.OnAdd += (key) => OnInventoryUpdate(SyncIDictionary<Vector2Byte, ItemData>.Operation.OP_ADD, key, inventoryData[key]);
            inventoryData.OnSet += (key, oldValue) => OnInventoryUpdate(SyncIDictionary<Vector2Byte, ItemData>.Operation.OP_SET, key, inventoryData[key]);
            inventoryData.OnRemove += (key, oldValue) => OnInventoryUpdate(SyncIDictionary<Vector2Byte, ItemData>.Operation.OP_REMOVE, key, oldValue);
            
            equipmentData.OnAdd += (key) => EquipmentSystem.OnEquipmentUpdate(SyncIDictionary<EquipmentSlot, ItemData>.Operation.OP_ADD, key, equipmentData[key]);
            equipmentData.OnSet += (key, oldValue) => EquipmentSystem.OnEquipmentUpdate(SyncIDictionary<EquipmentSlot, ItemData>.Operation.OP_SET, key, equipmentData[key]);
            equipmentData.OnRemove += (key, oldValue) => EquipmentSystem.OnEquipmentUpdate(SyncIDictionary<EquipmentSlot, ItemData>.Operation.OP_REMOVE, key, oldValue);
