    ...
    public class ResourceUI : MonoBehaviour, IResourceUI
    {
        ...
        public void SetResourceType(SecondaryResourceType resourceType)
        {
            ...
            bool showResourceBar = resourceType != SecondaryResourceType.None && 
                                   resourceType != SecondaryResourceType.ComboPoints;
            bool showComboPoints = resourceType == SecondaryResourceType.ComboPoints ||
                                   resourceType == SecondaryResourceType.Energy; // Rogues have both
        ...
        private void UpdateFromResourceSystem()
        {
            ...
            // Update combo points if applicable (Rogue)
            if (_resourceType == SecondaryResourceType.Energy || 
                _resourceType == SecondaryResourceType.ComboPoints)
            {
        ...
        private void UpdateResourceBarColor()
        {
            ...
            {
                SecondaryResourceType.Energy => _energyColor,
                SecondaryResourceType.Focus => _focusColor,
                SecondaryResourceType.Rage => _rageColor,
                SecondaryResourceType.HolyPower => _holyPowerColor,
                _ => _defaultColor
            };
        ...
        private void UpdateResourceTypeLabel()
        {
            ...
            {
                SecondaryResourceType.Energy => "Energy",
                SecondaryResourceType.Focus => "Focus",
                SecondaryResourceType.Rage => "Rage",
                SecondaryResourceType.HolyPower => "Holy Power",
                SecondaryResourceType.ComboPoints => "Combo Points",
                _ => ""
            };
